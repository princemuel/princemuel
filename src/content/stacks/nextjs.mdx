...
<svg
  ...
  aria-hidden="true"
  role="img"
  className="dark:[&_defs_linearGradient:nth-child(1)_stop]:[stop-color:#000] dark:[&_defs_linearGradient:nth-child(2)_stop]:[stop-color:#000] dark:[&_g_circle]:fill-white"
  width="1em"
  height="1em"
  viewBox="0 0 256 256"
>
