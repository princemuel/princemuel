...
import { Link } from "@/components/astro";

export const components = { a: Link };

As the [Astro docs](https://docs.astro.build/en/recipes/reading-time/ "Visit the Astro docs") say, we can use remark plugin to add a reading time property in our frontmatter. However, for some reason, we can't add this feature by following what stated in Astro docs. Therefore, to achieve this, we have to tweak a little bit. This post will demonstrate how we can do that.
